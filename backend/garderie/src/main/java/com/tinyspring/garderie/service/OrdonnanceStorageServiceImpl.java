...
@Service
public class OrdonnanceStorageServiceImpl implements OrdonnanceStorageService {

    private final Path ordonnancesDir;

    public OrdonnanceStorageServiceImpl(@Value("${app.uploads.ordonnances-dir:uploads/ordonnances}") String ordonnancesDir) {
