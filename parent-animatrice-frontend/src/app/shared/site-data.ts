...
export const parentModules: ModuleCard[] = [
  ...
  { title: 'Transport', description: 'Faire une demande de transport selon trajet et horaire.', action: 'Demander un transport', colorClass: 'bg-info', route: '/parent/transport' },
