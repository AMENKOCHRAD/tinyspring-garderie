...
@Component({
  selector: 'app-parent-boutique-especes-confirme-page',
  standalone: true,
  ...
  template: `
    <div class="ts-container workspace-page">
      <section class="table-card payment-state">
        ...
        <h1>Paiement en especes confirme !</h1>
        <p class="muted">Votre commande sera preparee. Vous paierez en especes a la remise.</p>
        <p class="muted">L equipe TinySpring vous contactera pour organiser la remise.</p>
        <div class="payment-state__actions">
          ...
          <a routerLink="/parent/boutique" class="ts-button ts-button--ghost">Retour a la boutique</a>
        </div>
      </section>
    </div>
  `,
...
export class ParentBoutiqueEspecesConfirmePageComponent {}
