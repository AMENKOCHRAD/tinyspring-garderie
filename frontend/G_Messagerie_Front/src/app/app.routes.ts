...
import { ReclamationsWorkspacePageComponent } from './pages/reclamations-workspace-page.component';
...
export const routes: Routes = [
  ...
  { path: 'login', component: LoginPageComponent },
  {
    ...
    children: [
      ...
      { path: 'reclamations', component: ReclamationsWorkspacePageComponent },
  ...
  { path: 'animateur', redirectTo: 'animatrice', pathMatch: 'full' },
  { path: 'animateur/:page', redirectTo: 'animatrice/:page' },
  { path: 'admin', redirectTo: 'connexion', pathMatch: 'full' },
  { path: '**', redirectTo: '' }
];
