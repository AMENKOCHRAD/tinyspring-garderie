...
import { WorkspaceNavGroup, WorkspaceRole, workspaceNavByRole } from '../shared/tinyspring-data';
...
export class WorkspaceShellComponent {
  ...
  protected readonly role = signal<WorkspaceRole>(this.route.snapshot.data['role'] as WorkspaceRole);
  ...
  protected readonly roleLabel = computed(() => (this.role() === 'PARENT' ? 'Espace parent' : 'Espace animatrice'));
